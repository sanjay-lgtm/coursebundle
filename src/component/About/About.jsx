...
export const Founder = () => (
  <Stack direction={['column', 'row']} spacing={['4', '16']} padding={'8'}>
    ...
    <VStack justifyContent={'center'} alignItems={['center', 'flex-start']}>
      <Heading children="sanjay" size={['md', 'xl']} />
      <Text
        textAlign={['center', 'left']}
        children={
          'Hi I am a full-stack developer and a teacher.Our mission is to provide quality content at resonable price'
        }
      />
    </VStack>
  </Stack>
    ...
    <Container maxW={'container.lg'} padding="16" boxShadow={'lg'}>
      ...
      <Stack m="8" direction={['column', 'row']} alignItems="center">
        <Text fontFamily={'cursive'} m={'8'} textAlign={['center', 'left']}>
          We are a team of 3 people who love to code and learn new things
          everyday. We have been working on this project for almost two years
        </Text>
        <Link to="/subscribe">
